      ...
      /*
        ...
        */
        let minuscula = document.getElementById("btn_mayusculas")
        let calculateDogAge = document.getElementById("btn_añoshumano")
        let pokeon = document.getElementById("btn_muestra")
        minuscula.addEventListener("click",LowerCase)
        calculateDogAge.addEventListener("click",humanDogAge)
        pokeon.addEventListener("click",pokeon)
        ...
        function LowerCase(event) {
            ...
            let newNewNames = newNames.split(",");
    ...
    */
        function humanDogAge(event){
          event.preventDefault()
          let dogAges = document.getElementById("edad_humano").value
          let newDogAges = dogAges * 7;
          console.log(newDogAges)
